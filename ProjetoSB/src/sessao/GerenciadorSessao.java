...
/**
 * Classe com os métodos para criar mapa que armazena os usu�rios ligados ao sistema com sessionId como chave do mapa e o login como valor
 *
 * @since 28.09.14
 * @author grupo
 */
public class GerenciadorSessao {
	...
	/*
	 * Mapa que guardará os usuários que estão logados no sistema
	 * O SessionId será a chave do mapa e o login do Usuario será o valor
	 */
	...
	/**
	 * Método para criar e retornar uma id de um usuario que est� logando no sistema
	 */
	...
	/**
	 * Método para apagar o id do mapa como consequ�ncia da desconex�o do sistema 
	 */
